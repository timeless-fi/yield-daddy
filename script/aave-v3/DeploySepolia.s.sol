...
contract DeployScript is Script {
    function run() public returns (AaveV3ERC4626Factory deployed) {
        ...
        address rewardsController = vm.envAddress("AAVE_V3_REWARDS_CONTROLLER_SEPOLIA");
        address rewardRecipient = vm.envAddress("AAVE_V3_REWARDS_RECIPIENT_SEPOLIA");
        address lendingPool = vm.envAddress("AAVE_V3_LENDING_POOL_SEPOLIA");

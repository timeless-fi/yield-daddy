...
contract DeployScript is Script {
    function run() public returns (AaveV3ERC4626Factory deployed) {
        ...
        address rewardsController = vm.envAddress("AAVE_V3_REWARDS_CONTROLLER_BASE");
        address rewardRecipient = vm.envAddress("AAVE_V3_REWARDS_RECIPIENT_BASE");
        address lendingPool = vm.envAddress("AAVE_V3_LENDING_POOL_BASE");
